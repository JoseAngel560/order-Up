...
router.get('/dashboard', async (req, res) => {
    try {
        ...
        const monedaObjetivo = restaurante.configuracion.moneda; // Ej: 'NIO'
        ...
        const facturasDelMes = await Factura_1.default.find({
        ...
        const rankingQuery = Pedido_1.default.aggregate([
        ...
        const categoriasQuery = Pedido_1.default.aggregate([
        ...
        const horariosPicoQuery = Factura_1.default.aggregate([

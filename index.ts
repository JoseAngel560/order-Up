...
// Import de Firebase para verificación (opcional)
...
async function loadRoutes() {
  try {
    const [
      ...
      import('./routes/reportesArqueoRoutes').then(m => m.default)
    ]);
...
app.get('/', (_, res: Response) => res.send('API Food Gestor - Listo'));
